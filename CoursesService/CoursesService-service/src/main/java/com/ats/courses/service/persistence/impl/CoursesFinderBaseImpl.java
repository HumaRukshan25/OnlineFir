 ...
 * @generated
 */
public abstract class CoursesFinderBaseImpl
	extends BasePersistenceImpl<Courses> {

	public CoursesFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return coursesPersistence.getBadColumnNames();
	}
